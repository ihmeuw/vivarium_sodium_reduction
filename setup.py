...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "vivarium_sodium_reduction", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/vivarium_sodium_reduction/_version.py",
        ...
        entry_points="""
            [console_scripts]
            make_artifacts=vivarium_sodium_reduction.tools.cli:make_artifacts
            make_results=vivarium_sodium_reduction.tools.cli:make_results
        """,
    )
