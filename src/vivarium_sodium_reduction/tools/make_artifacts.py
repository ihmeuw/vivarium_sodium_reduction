...
from vivarium_sodium_reduction.constants import data_keys, metadata
from vivarium_sodium_reduction.tools.app_logging import add_logging_sink, decode_status
from vivarium_sodium_reduction.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from vivarium_sodium_reduction.data import builder
